  ...
  <div className="container">
    ...
    <div className='row'>
      ...
      <img className='d-block mx-auto' width="48" height="48" src="https://img.icons8.com/stickers/100/video.png" alt="video"/>
        ...
        <p className='fs-6'>Today, video recording quality is improving daily and the size of video files is also increasing. We thus end up with files as large as several Gbs. Luckily TransferNow enables you to share videos of every size.</p>     
      </div>
      <div className="card col-lg-5">
      <img className='d-block mx-auto' width="48" height="48" src="https://img.icons8.com/cotton/64/gallery.png" alt="gallery"/>
        <h3 className='text-center'>Send photos, upload and host images</h3>
